...
const CheckoutPage = () => {
  ...
  const [selectedDeliveryLocaiton, setSelectedDeliveryLocaiton] =
        ...
        >
          ...
          {selectedCountry === "Bangaldesh" && (
            <div className=" flex flex-row gap-4 text-center">
              <button
                onClick={() => setSelectedDeliveryLocaiton("Insite-Dhaka")}
                className={` py-4 w-48  px-2 ${
                  selectedDeliveryLocaiton === "Insite-Dhaka"
              ...
              <button
                onClick={() => setSelectedDeliveryLocaiton("Onsite-Dhaka")}
                className={` py-4 w-48  px-2 ${
                  selectedDeliveryLocaiton === "Onsite-Dhaka"
                    ? "bg-[#132842] text-white"
                    : "bg-slate-200"
                } `}
              >
