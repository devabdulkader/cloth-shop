...
import Collections from "./dropdown/Collections"; // Update the import path as needed
    ...
    <section className="lg:relative">
      <nav className="font-inter mx-auto h-auto w-full lg:top-0">
        <div className="flex items-center px-6 py-6 lg:px-10 lg:py-4 xl:px-20">
          {/* NavLinks */}
          <div className="flex-grow flex items-center justify-start space-x-4 lg:space-x-6 w-2/5 ">
          ...
          {/* NavIcons */}
          <div className="flex-grow flex items-end justify-end space-x-4 lg:space-x-6 w-2/5">
            <NavIcons />
          </div>
        </div>
      </nav>
